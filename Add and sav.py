...
update_button = Button(text='SAVE', font=('Verdana', 16), command = update_file)
next_button = Button(text='NEXT', font=('Verdana', 14), command = next_item)
total_button = Button(text='TOTAL', font=('Verdana', 14), command = total_books)
